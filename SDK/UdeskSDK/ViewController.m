...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = RGBACOLOR(275.0f, 275.0f, 275.0f, 1);
    
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake((MDK_SCREEN_WIDTH-170)/2, 10, 170, 40)];
    label.text = @"欢迎使用Udesk SDK";
    label.backgroundColor = [UIColor clearColor];
    [self.view addSubview:label];
    
    UILabel *label1 = [[UILabel alloc] initWithFrame:CGRectMake((MDK_SCREEN_WIDTH-280)/2, label.frame.origin.y + label.frame.size.height, 280, 40)];
    label1.text = @"以下是展示Udesk SDK功能的按钮";
    label1.backgroundColor = [UIColor clearColor];
    [self.view addSubview:label1];
    
    UIButton *button1 = [UIButton buttonWithType:UIButtonTypeCustom];
    button1.frame = CGRectMake((MDK_SCREEN_WIDTH-130)/2, label1.frame.origin.y + label1.frame.size.height+10, 130, 40);
    ...
    button2.frame = CGRectMake((MDK_SCREEN_WIDTH-130)/2, button1.frame.origin.y + button1.frame.size.height+20, 130, 40);
    ...
    button3.frame = CGRectMake((MDK_SCREEN_WIDTH-130)/2, button2.frame.origin.y + button2.frame.size.height+20, 130, 40);
