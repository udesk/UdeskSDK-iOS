...
+ (UDTopAlertView*)viewWithParentView:(UIView*)parentView{
    ...
    for (UIView *view in array) {
        if ([view isKindOfClass:[UDTopAlertView class]]) {
            return (UDTopAlertView *)view;
        }
    }
    return nil;
}

+ (UDTopAlertView*)viewWithParentView:(UIView*)parentView cur:(UIView*)cur{
    NSArray *array = [parentView subviews];
    for (UIView *view in array) {
        if ([view isKindOfClass:[UDTopAlertView class]] && view!=cur) {
            return (UDTopAlertView *)view;
        }
    }
    return nil;
...
+ (void)hideViewWithParentView:(UIView*)parentView{
    ...
    for (UIView *view in array) {
        if ([view isKindOfClass:[UDTopAlertView class]]) {
            UDTopAlertView *alert = (UDTopAlertView *)view;
            [alert hide];
        }
    }
}
...
- (void)show{
    ...
    UDTopAlertView *lastAlert = [UDTopAlertView viewWithParentView:self.superview cur:self];
    if (lastAlert) {
