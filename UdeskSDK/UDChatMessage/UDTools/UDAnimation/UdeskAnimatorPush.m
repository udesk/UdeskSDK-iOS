...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext {
    ...
    [[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey] beginAppearanceTransition:YES animated:YES];
        //5.动画效果
    [UIView animateWithDuration:0.35 animations:^{
        ...
        [[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey] endAppearanceTransition];
    }];
