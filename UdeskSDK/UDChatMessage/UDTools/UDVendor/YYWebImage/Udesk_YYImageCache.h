...
@class Udesk_YYMemoryCache, Udesk_YYDiskCache;
 ...
 */
@interface Udesk_YYImageCache : NSObject
...
@property (strong, readonly) Udesk_YYMemoryCache *memoryCache;

/** The underlying disk cache. see `YYDiskCache` for more information.*/
@property (strong, readonly) Udesk_YYDiskCache *diskCache;
