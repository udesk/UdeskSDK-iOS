...
NSString *const Udesk_YYWebImageFadeAnimationKey = @"YYWebImageFade";
const NSTimeInterval Udesk_YYWebImageFadeTime = 0.2;
const NSTimeInterval Udesk_YYWebImageProgressiveFadeTime = 0.4;


@implementation Udesk_YYWebImageSetter {
