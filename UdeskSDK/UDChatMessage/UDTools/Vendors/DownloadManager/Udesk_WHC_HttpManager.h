...
extern const NSInteger kUdeskWHCDefaultDownloadNumber;

/**
 * 说明: WHC_HttpManager http请求管理类 (单例设计模式 支持POST/GET 请求 文件上传 文件下载)
 */

@interface Udesk_WHC_HttpManager : NSObject
...
- (nullable Udesk_WHC_DownloadOperation *)replaceCurrentDownloadOperationDelegate:(nullable id<WHC_DownloadDelegate>)delegate
                                       fileName:(nonnull NSString *)fileName;
...
- (nullable Udesk_WHC_DownloadOperation *)replaceAllDownloadOperationDelegate:(nullable id<WHC_DownloadDelegate>)delegate;
