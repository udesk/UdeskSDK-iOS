...
@implementation Udesk_YYImage {
    Udesk_YYImageDecoder *_decoder;
    NSArray *_preloadedFrames;
    dispatch_semaphore_t _preloadedLock;
    NSUInteger _bytesPerFrame;
}

+ (Udesk_YYImage *)imageNamed:(NSString *)name {
...
+ (Udesk_YYImage *)imageWithContentsOfFile:(NSString *)path {
    return [[self alloc] initWithContentsOfFile:path];
}

+ (Udesk_YYImage *)imageWithData:(NSData *)data {
    return [[self alloc] initWithData:data];
}

+ (Udesk_YYImage *)imageWithData:(NSData *)data scale:(CGFloat)scale {
    return [[self alloc] initWithData:data scale:scale];
}
...
- (instancetype)initWithData:(NSData *)data scale:(CGFloat)scale {
    ...
    @autoreleasepool {
        ...
        Udesk_YYImageFrame *frame = [decoder frameAtIndex:0 decodeForDisplay:YES];
