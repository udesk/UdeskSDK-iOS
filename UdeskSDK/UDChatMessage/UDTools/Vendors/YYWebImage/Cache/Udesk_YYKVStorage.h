 ...
 */
@interface Udesk_YYKVStorageItem : NSObject
 ...
 */
@interface Udesk_YYKVStorage : NSObject
 ...
 */
- (nullable Udesk_YYKVStorageItem *)getItemForKey:(NSString *)key;
 ...
 */
- (nullable Udesk_YYKVStorageItem *)getItemInfoForKey:(NSString *)key;
 ...
 */
- (nullable NSArray<Udesk_YYKVStorageItem *> *)getItemForKeys:(NSArray<NSString *> *)keys;
...
/**
 ...
 @return An array of `YYKVStorageItem`, or nil if not exists / error occurs.
 */
- (nullable NSArray<Udesk_YYKVStorageItem *> *)getItemInfoForKeys:(NSArray<NSString *> *)keys;
