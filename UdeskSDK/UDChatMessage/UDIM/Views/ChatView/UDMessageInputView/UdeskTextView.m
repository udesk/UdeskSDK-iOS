...
- (NSUInteger)numberOfLinesOfText {
    return [UdeskTextView numberOfLinesForMessage:self.text];
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
    return (text.length / [UdeskTextView maxCharactersPerLine]) + 1;
}
