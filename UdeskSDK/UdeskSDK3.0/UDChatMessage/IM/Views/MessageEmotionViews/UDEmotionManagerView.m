...
- (void)setup {
    ...
    UIImage *deleteImage = [UIImage imageWithContentsOfFile:getUDBundlePath(@"ud_deleteMessage_Button@2x.png")];
    UIImage *deleteImageh = [UIImage imageWithContentsOfFile:getUDBundlePath(@"ud_deleteMessage_ButtonH@2x.png")];
