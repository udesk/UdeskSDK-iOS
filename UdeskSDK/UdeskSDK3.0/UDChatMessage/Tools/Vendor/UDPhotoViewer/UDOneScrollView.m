...
@interface UDOneScrollView()<UIScrollViewDelegate>
{
...
@end
@implementation UDOneScrollView
...
-(void)setLocalImage:(UIImageView *)imageView withImageMessage:(UDMessage *)message
{
    ...
    [UIView animateWithDuration:AnimationTime animations:^{
        ...
        [self setFrameAndZoom:imageView withImageMessage:message];
...
-(void)setFrameAndZoom:(UIImageView *)imageView withImageMessage:(UDMessage *)message
{
    //ImageView.image的大小
    CGFloat   imageH;
    CGFloat   imageW;
    ...
    }else//不空
    {
        ...
        //放大的图片 显示原图片 不缩小
        self.mainImageView.image = [[UDCache sharedImageCache] imageFromDiskCacheForKey:message.contentId];
    }
