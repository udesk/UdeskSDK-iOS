...
//    NSString* cachePath = cachePathForKey(_diskCachePath, key);
//    dispatch_queue_t _diskQueue = dispatch_queue_create("com.udesk.udeskcache.disk", DISPATCH_QUEUE_CONCURRENT);
