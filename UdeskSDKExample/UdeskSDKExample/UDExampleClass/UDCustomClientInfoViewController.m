...
- (void)viewDidLoad {
    ...
    saveButton.backgroundColor = [UIColor udColorWithHexString:@"#0093FF"];
...
- (void)saveClientInfo {
    ...
    UdeskOrganization *organization = [[UdeskOrganization alloc] initWithDomain:[[NSUserDefaults standardUserDefaults] objectForKey:@"domain"]
                                                                         appKey:[[NSUserDefaults standardUserDefaults] objectForKey:@"key"]
                                                                          appId:[[NSUserDefaults standardUserDefaults] objectForKey:@"appId"]];
